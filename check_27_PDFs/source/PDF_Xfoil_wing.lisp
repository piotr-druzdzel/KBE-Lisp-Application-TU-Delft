(define-object PDF-xfoil-wing (base-drawing)
...
:computed-slots 
(
	(Generate-PDF-Xfoil-wing
						(the (pdf-xfoil-wing-gen!) )
	)
...
(
	(CL_Alpha_Plot
			...
			:object-roots (list (the PDF_wing_values xfoil-polar CL-alpha-plot))
	...
	(Airfoil_Curve
			...
			:object-roots (list (the PDF_wing_values airfoil-curve-object))
...
(
	(pdf-xfoil-wing-gen! ()
			...
			(let ((output-path "C:/Users/Simon/Desktop/check_27_PDFs/source/data/Xfoil_wing.pdf"))
